...
INSERT INTO "new_users" ("adminId", "barbeshopId", "born", "cellphone", "cpf", "email", "firstName", "id", "lastName", "password", "role", "unitId") SELECT "adminId", "barbeshopId", "born", "cellphone", "cpf", "email", "firstName", "id", "lastName", "password", "role", "unitId" FROM "users";
DROP TABLE "users";
